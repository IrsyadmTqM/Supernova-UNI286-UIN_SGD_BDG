...
# File dan URL
DATA_FILE = 'data.json'
ESP32_CAM_URL = "http://10.200.7.163/capture"  # Ganti IP ESP32-CAM
BUZZER_TRIGGER_URL = "http://10.200.37.215:5000/trigger-buzzer"  # Ganti sesuai IP Flask server
...
if st.button("🔊 Bunyi Buzzer"):
    try:
        res = requests.post(BUZZER_TRIGGER_URL, timeout=5)  # Timeout lebih lama
...
st.header("🧍 Deteksi Orang via Webcam (YOLOv3-tiny)")
